#ifndef DATA_FEED_BINANCE_USER_H
#define DATA_FEED_BINANCE_USER_H
...
class DataFeedBinanceUser : public DataFeedBinance
{
public:
    DataFeedBinanceUser(const string api_key, const string api_secret);
    DataFeedBinanceUser(){}
    ~DataFeedBinanceUser();
    ...
    //static void add_new_binance_user_data_stream(const StorageSourceBinance& storage_source);
...
private:
    ...
    //static std::unordered_map<std::string,DataFeedBinanceUser> m_data_user_stream_list;
};

#endif //DATA_FEED_BINANCE_USER_H
