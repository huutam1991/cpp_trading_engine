#ifndef BINANCE_BLVT_H
#define BINANCE_BLVT_H
...
class DataFeedBinanceBLVTUser;
class DataFeedBinanceBLVTInfo;
class DataFeedBinanceBLVTCandlestick;

class BinanceBLVT : public Exchange
{
public:
    BinanceBLVT();
    ~BinanceBLVT();
...
private:
    ...
    std::shared_ptr<DataFeedBinanceBLVTUser>     m_user_feed;
    std::map<std::string, std::shared_ptr<DataFeedBinanceBLVTInfo>>         m_info_feeds;
    std::map<std::string, std::shared_ptr<DataFeedBinanceBLVTCandlestick>>  m_kline_feeds;
};

#endif //BINANCE_BLVT_H