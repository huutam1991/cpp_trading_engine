#ifndef BINANCE_FUTURES_H
#define BINANCE_FUTURES_H
...
class DataFeedBinanceFuturesUser;
class DataFeedBinanceFuturesDepth;
class DataFeedBinanceFuturesBookTicker;
class DataFeedBinanceFuturesAggTrade;

class BinanceFutures : public Exchange
{
public:
    BinanceFutures();
    ~BinanceFutures();  
...
private:
    ...
    std::shared_ptr<DataFeedBinanceFuturesUser>     m_user_feed;
    std::map<std::string, std::shared_ptr<DataFeedBinanceFuturesDepth>>         m_depth_feeds;
    std::map<std::string, std::shared_ptr<DataFeedBinanceFuturesBookTicker>>    m_ticker_feeds;
    std::map<std::string, std::shared_ptr<DataFeedBinanceFuturesAggTrade>>      m_agg_trade_feeds;
};

#endif //BINANCE_FUTURES_H