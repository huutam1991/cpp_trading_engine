#ifndef API_HANDLER_BINANCE_24H_PROFIT_H
#define API_HANDLER_BINANCE_24H_PROFIT_H

#include <api_handler/api_handler_binance_spot/api_handler_binance.h>

class APIHandlerBinance24hProfit : public APIHandlerBinance
{
public:
    APIHandlerBinance24hProfit(HttpRequest* request);
...
#endif //API_HANDLER_BINANCE_24H_PROFIT_H