#ifndef API_HANDLER_BINANCE_BLVT_QUERY_SUBSCRIPTION_H
#define API_HANDLER_BINANCE_BLVT_QUERY_SUBSCRIPTION_H
...
*/
class APIHandlerBinanceBLVTQuerySubscripton : public APIHandlerBinanceBLVT
{
public:
    APIHandlerBinanceBLVTQuerySubscripton(HttpRequest* request);
...
#endif //API_HANDLER_BINANCE_BLVT_QUERY_SUBSCRIPTION_H