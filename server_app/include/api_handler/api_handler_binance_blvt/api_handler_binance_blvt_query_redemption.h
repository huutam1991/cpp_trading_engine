#ifndef API_HANDLER_BINANCE_BLVT_QUERY_REDEMPTION_H
#define API_HANDLER_BINANCE_BLVT_QUERY_REDEMPTION_H
...
*/
class APIHandlerBinanceBLVTQueryRedemption : public APIHandlerBinanceBLVT
{
public:
    APIHandlerBinanceBLVTQueryRedemption(HttpRequest* request);
...
#endif //API_HANDLER_BINANCE_BLVT_QUERY_REDEMPTION_H