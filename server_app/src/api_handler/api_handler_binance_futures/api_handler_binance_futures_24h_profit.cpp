...
//#include <api_handler/api_handler_binance_futures/api_handler_binance_current_price.h>

APIHandlerBinanceFutures24hProfit::APIHandlerBinanceFutures24hProfit(HttpRequest* request) : APIHandlerBinanceFutures(request)
{
    m_need_check_authentication = true;
    m_need_check_none_source = true;
}

Json APIHandlerBinanceFutures24hProfit::get_filled_order_list_in_24h(StorageSource* storage_source)
{
...
Json APIHandlerBinanceFutures24hProfit::get_filled_order_list_by_days_ago(StorageSource* storage_source, int days_ago)
{
...
Json APIHandlerBinanceFutures24hProfit::get_filled_order_list_by_day(StorageSource* storage_source, long from, long to)
{
...
long double APIHandlerBinanceFutures24hProfit::get_asset_profit_by_order(Json& order)
{
...
long double APIHandlerBinanceFutures24hProfit::get_currency_profit_by_order(Json& order)
{
    long double executedQty = std::stold((std::string&&)order["last_executed_quantity"]);
...
long double APIHandlerBinanceFutures24hProfit::get_asset_commission_by_order(const std::string& asset, Json& order)
{
...
Json APIHandlerBinanceFutures24hProfit::calculate_profit_in_24h(const Json& orders, const std::vector<std::string>& asset_list)
{
    Json profit;
...
HttpResponse APIHandlerBinanceFutures24hProfit::child_handle()
{
