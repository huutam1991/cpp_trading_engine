...
private:
    ...
    Task<HttpResponse> check_handle_by_route_group(HttpRequest* request);
    Task<HttpResponse> check_handle_by_route(HttpRequest* request);
    HttpResponse check_send_file_from_dashboard_folder(HttpRequest* request);
...
public:
    ...
    Task<HttpResponse> handle_request_base_on_route(HttpRequest* request);
};
