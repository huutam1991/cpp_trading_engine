...
{
    int port;
    std::function<Task<std::expected<bool, std::string>>(int, std::string, std::string)> on_connect = nullptr;
    ...
    void set_callbacks(
        std::function<Task<std::expected<bool, std::string>>(int, std::string, std::string)> on_connect_callback = nullptr,
